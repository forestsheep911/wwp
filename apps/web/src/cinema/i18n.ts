...
export const zhCN = {
  ...
  download: {
    preparing: "正在准备下载",
    ready: "下载已准备好",
    preparingDescription: "系统正在获取最新文件地址，请稍候。",
    refreshingLink: "正在获取最新下载地址",
    directDescription: "如果下载没有自动开始，可以重新点击免费下载；也可以直接免费播放。",
    failed: "下载地址获取失败",
    failedDescription: "系统暂时没有拿到可用文件地址，请稍后再试。",
    freeDownload: "免费下载",
    freePlayback: "免费播放",
    directFallback: "不同浏览器对下载的处理略有不同；如果没有反应，请再点一次免费下载。",
  ...
  help: {
    ...
    sourcesTitle: "资料来源",
    sourcesBody: "人物与影视基础资料会参考 TMDB，并结合 Wikidata、IMDb 及其他公开资料进行人工核对；网站只展示经过整理的字段和 WWP 实际收录作品。",

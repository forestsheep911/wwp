...
export const zhCN = {
  ...
  access: {
    ...
    wake: {
      title: "TELE CHAT",
      chatTitle: "午夜场排队等候群",
      groupAvatar: "午夜场排队等候群头像",
      gatekeeperAvatar: "守片人头像",
      visitorAvatar: "观众头像",
      chat: [
        { from: "gatekeeper", text: "此路暂缓通行。" },
        { from: "visitor", text: "能不能通融一下？" },
        { from: "gatekeeper", text: "你有没有带人事？" },
        { from: "visitor", text: "什么是人事？" },
        { from: "gatekeeper", text: "就是很懂事的意思。" },
        { from: "visitor", text: "我带了礼貌。" },
        { from: "gatekeeper", text: "礼貌可以，先排队。" },
        { from: "visitor", text: "队在哪里？" },
        { from: "gatekeeper", text: "在时间后面。" },
        { from: "visitor", text: "那时间排得动吗？" },
        { from: "gatekeeper", text: "它一直在动，只是不听指挥。" },
        { from: "visitor", text: "我是午夜场的。" },
        { from: "gatekeeper", text: "午夜场也要等月亮验票。" },
        { from: "visitor", text: "月亮今天请假了。" },
        { from: "gatekeeper", text: "那就等云散会儿。" },
        { from: "visitor", text: "我可以先进去坐黑暗里吗？" },
        { from: "gatekeeper", text: "黑暗正在整理座位。" },
        { from: "visitor", text: "它动作快吗？" },
        { from: "gatekeeper", text: "看过艺术片，比较慢。" },
        { from: "visitor", text: "我背两句台词行不行？" },
        { from: "gatekeeper", text: "别背，隔壁厅会以为开演了。" },
        { from: "visitor", text: "那我小声一点。" },
        { from: "gatekeeper", text: "小声也有字幕。" },
        { from: "visitor", text: "你这门槛挺文艺。" },
        { from: "gatekeeper", text: "门槛刚从资料馆回来。" },
        { from: "visitor", text: "它看懂了吗？" },
        { from: "gatekeeper", text: "没懂，但写了三页笔记。" },
        { from: "visitor", text: "现在可以通行了吗？" },
        { from: "gatekeeper", text: "再等一颗爆米花冷静下来。" },
        { from: "visitor", text: "爆米花也需要冷静？" },
        { from: "gatekeeper", text: "它刚知道自己不是玉米了。" },
        { from: "visitor", text: "那我陪它缓一缓。" },
        { from: "gatekeeper", text: "很好，银幕喜欢有耐心的人。" }
      ]
    },
    errors: {

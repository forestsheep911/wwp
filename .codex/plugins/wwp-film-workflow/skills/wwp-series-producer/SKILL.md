...
4. Before manual upload is expected, run the prepare-only series upload flow to create or reuse the target spec page and episode child pages so each finished file has a precise destination.
